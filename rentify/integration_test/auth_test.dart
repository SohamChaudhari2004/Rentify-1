...
import 'package:rentify/auth_service.dart'; // Fixed path to auth_service
import 'package:rentify/main.dart' as app;
import '../test/helper/auth_test_helper.dart'; // Added missing import
  ...
  group('Authentication Flow Tests', () {
    testWidgets('✅ Login with valid credentials and navigate to home', (
      ...
      await TestHelper.enterCredentials(
        tester,
        email: 'sohamrc08@gmail.com', // Valid test account
        password: '12345678',
      );
      ...
      final bool isEitherFound = backButtonFinder.evaluate().isNotEmpty ||
