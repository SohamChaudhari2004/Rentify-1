...
import 'package:rentify/presentation/pages/maps_details_page';
import 'package:rentify/presentation/widgets/car_card.dart';
import 'package:rentify/presentation/widgets/more_card.dart';
...
class _CardDetailsPageState extends State<CardDetailsPage>
  ...
  @override
  void dispose() {
    _controller.dispose(); // Changed from forward() to dispose()
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          CarCard(car: Car(model:"fortuner GR", distance: 870.00, fuelCapacity: 50.00, pricePerHour: 45.00),), // Use the existing car instance
          const SizedBox(
            height: 20,
          ),
          Padding(
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          // MaterialPageRoute(builder: (context) => MapsDetailsPage(car: Car(model: 'model', distance: 80.00, fuelCapacity: 25.00, pricePerHour: 45))));
